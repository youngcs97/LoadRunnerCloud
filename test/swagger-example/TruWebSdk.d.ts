// Type definitions for [TruWeb SDK] [2019.5]
// Project: [TruWeb]
...
declare namespace load {
    ...
    export class WebSocket {
         ...
         *
         * @param {*} dataToSend
         * @param {boolean} isMessageBinary, default is set to false, must be set to true when 'dataToSend' is binary
         * @returns {Function}
         * @memberof WebSocket
         */
        send(dataToSend: string | ArrayBuffer, isMessageBinary?: boolean): Function;
         ...
         *
         * @param {number} timeout (Default: 120000 milliseconds) use -1 for unlimited.
         * @returns {Function}
         * @memberof WebSocket
         */
         ...
         *Enables to block the iteration ending till the connection have been disconnected by the following options:
         ...
         3. the timeout passed to the function has elapsed.
         *
         * @param {number} timeout optional in ms
         * @returns {Function}
         * @memberof WebSocket
         */
        waitForClose(timeout?: number): Function;
    ...
    export class WebResponse {
        ...
        startTime: number; // The UNIX time-stamp in milliseconds of the engine time on which the request RoundTrip has started.
     ...
     *         caseInSensitive ? : boolean, If set to false then the search will be using case-sensitive comparison. Default is true.
    ...
    export function BoundaryExtractor(name: string, options: {
        ...
        occurrence?: string | number, // The occurrence (previously Ordinal) of the result to return. If occurrence is not defined then the first occurrence is returned.
        caseInSensitive?: boolean, // If set to false then the search will be using case-sensitive comparison. Default is true.
        includeRedirections?: boolean // If set to true then the search will be performed on the headers and body of all the pages returned by redirection of the WebRequest
    });
    ...
    export interface RegexpExtractorOptions {
        expression: string;
        flags: string;
        groupNumber?: number; // The group number to return as a result (zero-based). If groupNumber is not defined then the first group is returned.
        occurrence?: string | number; // The occurrence (previously Ordinal) of the result to return. If occurrence is not defined then the first occurrence is returned
        includeRedirections?: boolean; // If set to true then the search will be performed on the headers and body of all the pages returned by redirection of the WebRequest
    }
    ...
    /**
     * This constructor creates a correlation object for the JSON path correlation.
     * @param {string} name
     * @param {string} path
    ...
    /**
     * This constructor creates a correlation object for the XPath correlation.
     * @param {string} name
     * @param {string} path
     * @param {boolean} returnMultipleValues - false or unspecified will return the first item otherwise return list
     */
    ...
    /**
     * This constructor creates a correlation object for the text check correlation.
     * @param {string} name
     * @param {string} text - The string to search
     * @param {string} scope (optional) - [ALL, HEADERS, BODY]
     */
     ...
     *The VTSClient is responsible for issuing commands to the VTS server.
     Use it to obtain other VTS related constructs such as VTSColumn and VTSRow. The client allows you to perform general operations which affect more than one column, row, or field.
     *
     * @export
     * @class VTSClient
     */
    export class VTSClient {
         ...
         * @param placementType
         */
        rotateColumns(columnNames: Array<string>, placementType: "VTSEND_STACKED" | "VTSEND_STACKED_UNIQUE"): Object
         ...
         * @param placementType
         */
        setValues(columnNames: Array<string>, values: Array<string>, placementType: "VTSEND_SAME_ROW" | "VTSEND_STACKED" | "VTSEND_STACKED_UNIQUE"): Object
    ...
    export class FileReadResult {
        content: string; //The entire content of the read file. This property is only available when "returnContent" is set to true in the read() options argument.
        extractors: object; //The extracted results of the given extractors. See the "Extractor results" section in the SDK documentation.
    ...
    export class File {
         ...
         * @path can be an absolute path or a relative path to the script directory.
         */
         ...
         */
        read(options: {
            forceRead?: boolean //(default: false) When set to true, will ignore the caching mechanism and read the file from disk. Use this option only if the read file can change during the script run.
            returnContent: boolean //(default: true) When true, the entire content of the file is returned (see correlation property for retrieving partial file data).
            correlations?: Array<ExtractorObject> //The user name.
            password?: string //A plain text password.
        }): void;
